...
import { specialtyServices, pricing } from '../data/services'

export default function Services() {
  return (
    <>
      <Seo
        title="Truck Repair Services & Pricing | Engine, Transmission & Brake Repair | Immortal Automotive"
        description="Transparent pricing on oil changes, brake repair, transmission service, engine diagnostics, and diesel performance upgrades in Sherwood Park, AB. See our full service menu and starting prices."
        path="/services"
      />
      {/* ── Page Hero ── */}
      <section className="relative min-h-[70vh] flex items-center overflow-hidden">
        <div className="absolute inset-0">
          <GrayscaleImage
            src="/truck-hero.webp"
            alt="White pickup truck serviced by Immortal Automotive in Sherwood Park"
      ...
      <section className="py-20 md:py-28 bg-brand-dark">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {specialtyServices.map(({ slug, icon: Icon, title, shortDesc, items }, i) => (
              <AnimatedSection key={title} delay={i * 0.1}>
                <Link to={`/services/${slug}`} className="block h-full">
                  ...
                  >
                    ...
                    <p className="text-white/50 text-sm leading-relaxed mb-4 flex-1">{shortDesc}</p>
                    ...
                    <span className="mt-auto inline-flex items-center gap-1 text-brand-orange text-sm font-semibold">
              ...
              <div className="card-dark p-8">
                ...
                <div className="space-y-4">
                  {[
                    ...
                    { label: 'Email', value: 'info@immortalauto.com', href: 'mailto:info@immortalauto.com' },
